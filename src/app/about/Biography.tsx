    ...
    <div className="space-y-4">
      ...
      <div className="bg-gray-200 dark:bg-gray-800 border-l-4 border-black dark:border-green-500 p-4">
        <p className="text-black dark:text-green-500">
          ...
          building web applications and programming.
        </p>
        {/* <p className="text-black dark:text-green-500">
      ...
      <p className="text-black dark:text-green-500">
        ...
        <span className="font-semibold">Chegg Inc</span> in Edmonton, AB, where
        I evolved from a front-end specialist to a full-stack engineer,
        mastering React.js, Node.js, federated GraphQL, and real-time
        subscriptions with AWS SNS and Lambda.
      </p>
      <p className="text-black dark:text-green-500">
        {">"} I&apos;ve also developed Chat Monster, an AI-powered customer
        service solution that generates an embeddable script for websites,
        enabling an AI-powered chatbot to answer customer queries and drive
